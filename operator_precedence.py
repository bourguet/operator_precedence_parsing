...
def binary_evaluator(args):
    if len(args) != 3 or type(args[0]) == SymbolDesc or type(args[1]) != SymbolDesc or type(args[2]) == SymbolDesc:
        return Node(lexer.Token('ERROR', 'BINARY ERROR'))
